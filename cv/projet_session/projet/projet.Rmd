...
\Huge \textbf{Projet de Session} \\[1.5cm]
\large \textbf{Nicholas Gaudet} \\  
537 284 355 \\[1cm]

\large Outils Numériques de Recherche \\  
POL-6078 \\[1.5cm]

\large Présenté à: \\  
\textbf{Adrien Cloutier} \\[1.5cm]

\large Département de science politique \\  
Faculté des sciences sociales \\  
Université Laval \\[1.5cm]

\large Québec, Canada \\[1.5cm]
