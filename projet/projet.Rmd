...
A l'aide de l'outil R, nous avons réussis a visualiser nos données afin de faire des régressions nous permettant d'analyser les relations entre notre variable francophone et notre variable électorale. Le code suivant nous apermis de faire une analyse de nos données. Voici le code utilisée:
